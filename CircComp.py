...
print(f"[d={DEPTH}] Median loss: {np.median(losses)}, stdev: {np.std(losses)}", flush=True)
print(f"[d={DEPTH}] Median loss: {np.median(queries)}, stdev: {np.std(queries)}", flush=True)
